    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-2xl border border-border bg-card/50 p-6 shadow-sm">
          <div className="gap-6 md:grid-cols-3 h-[580px] md:h-auto flex flex-col md:flex-row overflow-y-auto md:overflow-x-auto snap-mandatory p-4 w-full">
            {testimonials.items.map((item) => (
              <figure
                key={item.name}
                className="flex w-full md:w-95 shrink-0 snap-center flex-col rounded-2xl border border-border bg-card p-6 hover:cursor-pointer hover:border-primary transition-all duration-400 hover:scale-105"
              >
