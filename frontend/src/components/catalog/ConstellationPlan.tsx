    ...
    return (
        <>
            ...
            >
                ...
                <div className="mt-4 flex items-center justify-between text-xs sm:text-sm text-muted-foreground w-full min-w-0">
                    <span className="shrink-0">{constellation.stars.length} stars</span>
