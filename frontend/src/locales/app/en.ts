...
export const appEn = {
  ...
  catalogSeriesPage: {
    ...
    missingLink: "Missing series link.",
    readError: "Could not read playlist data.",
    requestFailed: "Request failed.",
    playlistSuffix: " — playlist",
    episode: "episode",
    episodes: "episodes",
    openLessonAria: "Open lesson",
  },
  ...
  profileHeader: {
    ...
    avatarSaveError: "Could not save profile photo.",
  },
  ...
  profileTeacherVideos: {
    ...
    cardTitle: "Your videos",
    intro:
      "Series you uploaded: open a lesson, jump to the series page, or change whether it appears in the public catalog.",
    ...
    uploadCancelledToast: "Upload cancelled.",
    visibilityOk: "Visibility updated.",
    visibilityError: "Could not update visibility.",
    titlePlaceholder: "Lesson title",
    titleExample: "e.g., Present Simple Explained",
    uploading: "Uploading…",
    uploadCta: "Upload lesson",
    uploadModalTitle: "Upload new lesson",
    cancel: "Cancel",
    cancelUpload: "Cancel upload",
    publishing: "Publishing…",
    publish: "Publish",
    browseMp4: "Browse for MP4",
    uploadHint: "This video will be available to your students",
    lessonTitleLabel: "Lesson Title",
    descriptionOptional: "Description (optional)",
    descriptionPlaceholder: "Short lesson summary…",
    cancelUploadTitle: "Cancel upload?",
    cancelUploadNo: "No, continue",
    cancelUploadYes: "Yes, cancel",
    cancelUploadBody: "Are you sure you want to cancel the video upload?",
    deleteVideoTitle: "Delete video",
    deleting: "Deleting…",
    deleteVideoCta: "Delete video",
    deleteVideoBody:
    ...
    visibilityAria: "Catalog visibility for {name}",
  ...
  profileTeacherStudents: {
    ...
    loading: "Loading student results…",
    cardTitle: "Student results",
    intro:
      "Overview of learners assigned to you: completed watches, comprehension quizzes, and recent quiz scores per lesson.",
    ...
    firstNameLabel: "First Name (English)",
    firstNamePlaceholder: "e.g. John",
    lastNameLabel: "Last Name (English)",
    lastNamePlaceholder: "e.g. Doe",
    generatedEmailLabel: "Generated Email Address",
    generatedEmailPlaceholder: "Auto-generated email",
    passwordHint:
      "A secure random password will be generated and shown to you after clicking Save.",
    registeredTitle: "Student registered!",
    credentialsSaved: "I have saved the credentials",
    credentialsLead:
      "Please copy and save these credentials now. For security reasons,",
    credentialsPasswordNote: "the password will not be shown again.",
    ...
    copyBoth: "Copy Both",
    bothCopied: "Both copied to clipboard!",
    removeStudentTitle: "Remove Student",
    removing: "Removing…",
    removeStudentCta: "Remove Student",
    removeStudentBody:
    ...
    exportError: "Failed to download Excel file",
    englishLettersOnly: "Please use English letters only",
    ...
    colActions: "Actions",
    editStudentAria: "Edit student",
    removeStudentAria: "Remove student",
    recentQuizzesHeading: "Recent comprehension quizzes",
    noQuizzesYet: "No quiz attempts recorded yet.",
    writtenSummary: "Written Summary",
    viewAllAnswers: "View all answers",
    quizDetailsTitle: "Quiz Details",
    quizDetailsNamed: "Quiz Details: {name}",
    close: "Close",
    finalScore: "Final Score",
    result: "Result",
    correctFraction: "/ {total} correct",
    studentInputs: "Student's Inputs",
    writtenSummaryCaps: "WRITTEN SUMMARY",
    noMcData: "No multiple-choice data saved for this attempt.",
    questionIdFallback: "Question ID: {id}…",
    correct: "Correct",
    studentChoice: "Student's choice",
    correctAnswer: "Correct answer",
    optionN: "Option {n}",
    noTextSaved: "(No text saved)",
  ...
  levelTestPage: {
    seoTitle: "English level test",
    seoDescription: "Determine your English level on Explys.",
    ...
    resultLead: "Based on your answers, your estimated English level is:",
    levels: {
      a1: "A1 (Beginner)",
      a2: "A2 (Elementary)",
      b1: "B1 (Intermediate)",
  ...
  classroomPage: {
    seoTitle: "Classroom",
    seoDescription: "Teacher and student classroom lessons on Explys.",
    title: "Classroom",
    leadTeacher: "Lessons you created for your students.",
    leadStudent: "Lessons assigned by your teacher.",
    loading: "Loading classroom…",
    empty: "No classroom lessons yet.",
    myLesson: "My Lesson",
    teacherLesson: "Teacher's Lesson",
    teacherTitle: "My uploaded lessons",
    studentTitle: "Classroom",
    teacherLead: "Videos you have published for your students.",
    studentLead: "Exclusive video lessons assigned by your teacher.",
    emptyTitle: "No lessons yet",
    emptyTeacher:
      "You haven't uploaded any videos yet. Go to your profile to upload lessons.",
    emptyStudent: "Your teacher hasn't assigned any videos to you yet.",
  },
  ...
  lesson: {
    ...
    quizDuringVideoLead: "Questions pause the video while you watch.",
    quizDuringVideoHint:
      "Answer each question to continue playback. Finish the clip for the written summary.",
    inVideoQuizHint: "Answer to continue watching",
    inVideoQuestionOf: "In-video question {current} of {total}",
    inVideoQuizProgress: "{answered} / {total} answered during video",
    continueWatching: "Continue watching",
    timelineQuestionMarker: "Question {n} at {time}",
    timelineQuestionAnswered: "Question {n} answered ({time})",
    selectOptionError: "Please select an option to continue.",
    questionOf: "Question {current} of {total}",
    categoryGrammar: "Grammar",
    categoryVocabulary: "Vocabulary",
    categoryComprehension: "Comprehension",
    ...
    vocabSavedToast: '"{word}" saved to your vocabulary!',
    vocabSaveError: "Failed to save word.",
  ...
  legacyCatalogPage: {
    ...
    networkError: "Backend unavailable or network error",
    consoleHint: "Open the browser console (F12) for details.",
    videoFallback: "Video",
    watchNow: "Watch now",
    empty: "No videos yet",
  },
